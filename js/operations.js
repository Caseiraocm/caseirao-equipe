...
.driverScreenNew{color:#15191e!important}.driverPremiumHero{background:linear-gradient(135deg,#f0a51f,#d97812 72%,#b9540b)!important;border:1px solid #b85b0e!important;color:#17120d!important;box-shadow:0 10px 26px rgba(113,58,8,.20)!important}.driverPremiumHead h2{color:#17120d!important}.driverPremiumHead small{color:#4f3217!important;font-weight:800!important}.driverPremiumIcon{background:#fff2cf!important;opacity:1!important}.driverPremiumStat{background:#fff8e9!important;border:1px solid #c98527!important;color:#17120d!important}.driverPremiumStat small{color:#5b4631!important}.driverPremiumStat b{color:#17120d!important;font-size:17px!important}.driverPremiumStat.total{background:#fff0d2!important;border-color:#b96b16!important}.driverPremiumStat.total b{color:#8b3100!important}.driverScreenNew .driverDaySummary{background:#fff!important;border:1px solid #d7dce1!important;box-shadow:0 5px 18px rgba(20,24,28,.07)!important}.driverScreenNew .driverDaySummary h3,.driverScreenNew .driverDaySummary strong{color:#1b2026!important}.driverScreenNew .mini{color:#424b55!important}.driverSectionHead h3{color:#171b20!important}.driverSectionHead span{background:#f2a51f!important;border:1px solid #b96b16!important;color:#2a1908!important;font-weight:950!important}.driverScreenNew>.empty{background:#fff!important;border:1px dashed #aeb6bf!important;color:#303841!important}.driverScreenNew>.empty b{color:#22282f!important}.driverScreenNew>.empty span{color:#59616a!important}.driverOrder{border-color:#cfd5db!important;box-shadow:0 7px 22px rgba(25,30,36,.09)!important}.driverOrder h3{color:#171b20!important}.driverQuickChip{background:#eef1f4!important;border-color:#d3d8de!important;color:#242a31!important}.driverStatus{color:#9a3d13!important}.driverInfoBlock{background:#f4f6f8!important;border:1px solid #d7dce1!important}.driverInfoBlock small{color:#5d6670!important}.driverInfoBlock strong{color:#151a20!important}.driverReference{color:#4e5862!important}.driverPaymentBlock{border:2px solid #d8a07d!important;background:#fff8f3!important}.driverChangePaymentBtn{width:100%;margin-top:10px;min-height:42px;border:1px solid #b94d19;border-radius:11px;background:#fff;color:#a13d10;font-weight:900}.driverPaymentChooser{display:grid;gap:10px;margin-top:10px}.driverPaymentOption{display:grid;grid-template-columns:42px 1fr auto;align-items:center;text-align:left;gap:10px;min-height:64px;padding:11px 13px;border:1px solid #d5dbe1;border-radius:14px;background:#fff;color:#1b2026}.driverPaymentOption>span{font-size:23px}.driverPaymentOption>b{font-size:16px}.driverPaymentOption small{font-size:9px;font-weight:900;color:#a13d10}.driverPaymentOption.selected{border:2px solid #b94d19;background:#fff5ee}
